...
public final class ImprovedDiskGen implements MapGen {
	...
	private static final RandomCollection<BlockState> STATES = new RandomCollection<BlockState>()
			.add(1, Blocks.SAND.getDefaultState())
			.add(1, Blocks.GRAVEL.getDefaultState());
